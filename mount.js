...
// Mount original systems without altering algorithms
...
<!-- 微信数据粘贴区 -->
<div class="card">
<div class="card-header">📋 微信数据导入</div>
<div class="card-body">
<div class="paste-section">
<textarea id="hiddenTxt" placeholder="将微信数据粘贴至此..."></textarea>
<div class="btn-group">
<button class="btn btn-primary" onclick="readCpy()">🔍 获取进水量</button>
<button class="btn btn-secondary" onclick="clean()">🗑️ 清空</button>
</div>
</div>
...
<label>一二系列进水量</label>
<input id="12" placeholder="请输入一二系列的总进水量" type="number"/>
</div>
<div class="input-group">
<label>三四系列进水量</label>
<input id="34" placeholder="请输入三四系列的总进水量" type="number"/>
</div>
<div class="input-group">
<label>五六系列进水量（总量）</label>
<input id="56" placeholder="请输入五六系列的总进水量" type="number"/>
</div>
...
<div>
<label style="font-size: 12px; color: #555;">5-1系进水</label>
<input id="water_51" style="width: 100%; height: 36px; border: 1px solid #90caf9; border-radius: 6px; text-align: center; font-size: 14px;" type="number"/>
</div>
<div>
<label style="font-size: 12px; color: #555;">5-2系进水</label>
<input id="water_52" style="width: 100%; height: 36px; border: 1px solid #90caf9; border-radius: 6px; text-align: center; font-size: 14px;" type="number"/>
</div>
<div>
<label style="font-size: 12px; color: #555;">6-1系进水</label>
<input id="water_61" style="width: 100%; height: 36px; border: 1px solid #90caf9; border-radius: 6px; text-align: center; font-size: 14px;" type="number"/>
</div>
<div>
<label style="font-size: 12px; color: #555;">6-2系进水</label>
<input id="water_62" style="width: 100%; height: 36px; border: 1px solid #90caf9; border-radius: 6px; text-align: center; font-size: 14px;" type="number"/>
</div>
</div>
<div style="font-size: 11px; color: #666; margin-top: 8px;">
      提示：修改后系统会记住比例，下次自动按此比例分配
    </div>
</div>
</div>
```
...
<!-- 加药计算 -->
<div class="card">
<div class="card-header">💊 加药计算</div>
<div class="card-body">

```
  <!-- 一期 -->
<div class="section-title">一期配置</div>
<div class="concentration-grid">
<label>混凝剂浓度（%）</label>
<input id="hn_con" step="0.1" type="number" value="10"/>
</div>
<div class="concentration-grid">
<label>助凝剂浓度（%）</label>
<input id="zn_con" step="0.1" type="number" value="5"/>
</div>
<div class="section-title">一期混凝剂差值</div>
<div class="diff-inputs">
<div class="diff-item">
<label>1系列混凝剂与上时段差值</label>
<input id="HN_adiff" type="number"/>
</div>
<div class="diff-item">
<label>2系列混凝剂与上时段差值</label>
<input id="HN_bdiff" type="number"/>
</div>
<div class="diff-item">
<label>3系列混凝剂与上时段差值</label>
<input id="HN_cdiff" type="number"/>
</div>
<div class="diff-item">
<label>4系列混凝剂与上时段差值</label>
<input id="HN_ddiff" type="number"/>
</div>
</div>
<div class="section-title">一期助凝剂差值</div>
<div class="diff-inputs">
<div class="diff-item">
<label>1系列助凝剂与上时段差值</label>
<input id="ZN_adiff" type="number"/>
</div>
<div class="diff-item">
<label>2系列助凝剂与上时段差值</label>
<input id="ZN_bdiff" type="number"/>
</div>
<div class="diff-item">
<label>3系列助凝剂与上时段差值</label>
<input id="ZN_cdiff" type="number"/>
</div>
<div class="diff-item">
<label>4系列助凝剂与上时段差值</label>
<input id="ZN_ddiff" type="number"/>
</div>
</div>
<!-- 二期 -->
<div class="section-title">二期配置</div>
<div class="concentration-grid">
<label>混凝剂浓度（%）</label>
<input id="hn_con2" step="0.1" type="number" value="10"/>
</div>
<div class="concentration-grid">
<label>助凝剂浓度（%）</label>
<input id="zn_con2" step="0.1" type="number" value="5"/>
</div>
<div class="section-title">二期混凝剂差值</div>
<div class="diff-inputs">
<div class="diff-item">
<label>5-1混凝剂与上时段差值</label>
<input id="HN_ediff1" type="number"/>
</div>
<div class="diff-item">
<label>5-2混凝剂与上时段差值</label>
<input id="HN_ediff2" type="number"/>
</div>
<div class="diff-item">
<label>6-1混凝剂与上时段差值</label>
<input id="HN_fdiff1" type="number"/>
</div>
<div class="diff-item">
<label>6-2混凝剂与上时段差值</label>
<input id="HN_fdiff2" type="number"/>
</div>
</div>
<div class="section-title">二期助凝剂差值</div>
<div class="diff-inputs">
<div class="diff-item">
<label>5-1助凝剂与上时段差值</label>
<input id="ZN_ediff1" type="number"/>
</div>
<div class="diff-item">
<label>5-2助凝剂与上时段差值</label>
<input id="ZN_ediff2" type="number"/>
</div>
<div class="diff-item">
<label>6-1助凝剂与上时段差值</label>
<input id="ZN_fdiff1" type="number"/>
</div>
<div class="diff-item">
<label>6-2助凝剂与上时段差值</label>
<input id="ZN_fdiff2" type="number"/>
</div>
</div>
<button class="btn btn-primary" onclick="do_cal()" style="width: 100%; margin-top: 16px;">
    🧮 计算加药量
  </button>
<div class="result-section">
<h3>📊 计算结果</h3>
<textarea id="result" readonly=""></textarea>
<button class="btn btn-primary" onclick="copy()" style="width: 100%; margin-top: 12px;">
      📋 复制加药数据
    </button>
</div>
</div>
...
<!-- 加氯计算 -->
<div class="card">
<div class="card-header">🧪 加氯计算</div>
<div class="card-body">

```
  <div class="checkbox-group">
<input id="isAdd" type="checkbox" value="1"/>
<label for="isAdd">启用补氯计算</label>
</div>
<!-- 一期加氯 -->
<div class="section-title">一期加氯</div>
<div class="concentration-grid">
<label>一期有效氯（%）</label>
<input id="effCL1" step="0.1" type="number"/>
</div>
<div class="diff-inputs" style="margin-top: 12px;">
<div class="diff-item">
<label>预加氯一二流量计底数差</label>
<input id="PreCL_ABdiff" type="number"/>
</div>
<div class="diff-item">
<label>预加氯三四流量计底数差</label>
<input id="PreCL_CDdiff" type="number"/>
</div>
<div class="diff-item">
<label>主加氯一二流量计底数差</label>
<input id="MainCL_ABdiff" type="number"/>
</div>
<div class="diff-item">
<label>主加氯三四流量计底数差</label>
<input id="MainCL_CDdiff" type="number"/>
</div>
</div>
<div class="section-title">一期补氯（可选）</div>
<div class="diff-inputs">
<div class="diff-item">
<label>一系补氯流量计底数差</label>
<input id="addCL_Adiff" type="number" value="0"/>
</div>
<div class="diff-item">
<label>二系补氯流量计底数差</label>
<input id="addCL_Bdiff" type="number" value="0"/>
</div>
<div class="diff-item">
<label>三系补氯流量计底数差</label>
<input id="addCL_Cdiff" type="number" value="0"/>
</div>
<div class="diff-item">
<label>四系补氯流量计底数差</label>
<input id="addCL_Ddiff" type="number" value="0"/>
</div>
</div>
<!-- 二期加氯 -->
<div class="section-title">二期加氯</div>
<div class="concentration-grid">
<label>二期有效氯（%）</label>
<input id="effCL2" step="0.1" type="number"/>
</div>
<div class="diff-inputs" style="margin-top: 12px;">
<div class="diff-item">
<label>5系列预加氯流量计底数差</label>
<input id="PreCL_Ediff" type="number"/>
</div>
<div class="diff-item">
<label>6系列预加氯流量计底数差</label>
<input id="PreCL_Fdiff" type="number"/>
</div>
<div class="diff-item">
<label>5系列主加氯流量计底数差</label>
<input id="MainCL_Ediff" type="number"/>
</div>
<div class="diff-item">
<label>6系列主加氯流量计底数差</label>
<input id="MainCL_Fdiff" type="number"/>
</div>
</div>
<button class="btn btn-primary" onclick="do_CLcal()" style="width: 100%; margin-top: 16px;">
    🧮 计算加氯量
  </button>
<div class="result-section">
<h3>📊 计算结果</h3>
<textarea id="result_" readonly=""></textarea>
<button class="btn btn-primary" onclick="copy_()" style="width: 100%; margin-top: 12px;">
      📋 复制加氯数据
    </button>
</div>
</div>
...
function readCpy() {
  ...
  const pattern12 = /(?<=【1-2系:\s*)\d+(?=】)/;
  const pattern34 = /(?<=【3-4系:\s*)\d+(?=】)/;
  const pattern56 = /(?<=【5-6系:\s*)\d+(?=】)/;
...
<input id="m_coag_p1" step="0.01" type="number"/>
<label>目标配置浓度（%）</label>
<input id="c_coag_p1" step="0.01" type="number"/>
...
<input id="h_aid_p1" step="0.01" type="number"/>
<label>目标配置浓度（%）</label>
<input id="c_aid_p1" step="0.1" type="number"/>
...
```
  <div class="box">
<label>固体药剂投加量（吨）</label>
<input id="m_coag_p2" step="0.01" type="number"/>
<label>目标配置浓度（%）</label>
<input id="c_coag_p2" step="0.01" type="number"/>
...
<div class="box">
<label>计量桶液位高度 H（m）</label>
<input id="h_aid_p2" step="0.01" type="number"/>
<label>目标配置浓度（%）</label>
<input id="c_aid_p2" step="0.1" type="number"/>
...
<label>一期混凝</label>
<input id="c_p1_m" inputmode="decimal" step="0.01" type="number"/>
</div>
<div class="concentration-item">
<label>一期助凝</label>
<input id="c_p1_a" inputmode="decimal" step="0.01" type="number"/>
</div>
<div class="concentration-item">
<label>二期混凝</label>
<input id="c_p2_m" inputmode="decimal" step="0.01" type="number"/>
</div>
<div class="concentration-item">
<label>二期助凝</label>
<input id="c_p2_a" inputmode="decimal" step="0.01" type="number"/>
</div>
</div>
</div>
<!-- 一期混凝 -->
<div class="card">
<div class="card-header">一期 · 混凝剂</div>
<div class="card-body">
...
<td><input id="p1m18" inputmode="decimal" type="number"/></td>
<td><input id="p1m28" inputmode="decimal" type="number"/></td>
<td><input id="p1m38" inputmode="decimal" type="number"/></td>
<td><input id="p1m48" inputmode="decimal" type="number"/></td>
<td class="result-cell" id="o_p1_m_12" rowspan="2">0.00</td>
<td class="result-cell" id="o_p1_m_34" rowspan="2">0.00</td>
</tr>
<tr>
<td class="time-cell">17:00</td>
<td><input id="p1m117" inputmode="decimal" type="number"/></td>
<td><input id="p1m217" inputmode="decimal" type="number"/></td>
<td><input id="p1m317" inputmode="decimal" type="number"/></td>
<td><input id="p1m417" inputmode="decimal" type="number"/></td>
</tr>
</tbody>
</table>
</div>
...
<!-- 一期助凝 -->
<div class="card">
<div class="card-header">一期 · 助凝剂</div>
<div class="card-body">
<div class="table-wrapper">
<table>
<thead>
...
<tr>
<td class="time-cell">8:00</td>
<td><input id="p1a18" inputmode="decimal" type="number"/></td>
<td><input id="p1a28" inputmode="decimal" type="number"/></td>
<td><input id="p1a38" inputmode="decimal" type="number"/></td>
<td><input id="p1a48" inputmode="decimal" type="number"/></td>
<td class="result-cell" id="o_p1_a_12" rowspan="2">0.00</td>
<td class="result-cell" id="o_p1_a_34" rowspan="2">0.00</td>
</tr>
<tr>
<td class="time-cell">17:00</td>
<td><input id="p1a117" inputmode="decimal" type="number"/></td>
<td><input id="p1a217" inputmode="decimal" type="number"/></td>
<td><input id="p1a317" inputmode="decimal" type="number"/></td>
<td><input id="p1a417" inputmode="decimal" type="number"/></td>
</tr>
</tbody>
</table>
</div>
...
<!-- 二期混凝 -->
<div class="card">
<div class="card-header">二期 · 混凝剂</div>
<div class="card-body">
<div class="table-wrapper">
<table>
<thead>
...
<tr>
<td class="time-cell">8:00</td>
<td><input id="p2m518" inputmode="decimal" type="number"/></td>
<td><input id="p2m528" inputmode="decimal" type="number"/></td>
<td><input id="p2m618" inputmode="decimal" type="number"/></td>
<td><input id="p2m628" inputmode="decimal" type="number"/></td>
<td class="result-cell" id="o_p2_m_5" rowspan="2">0.00</td>
<td class="result-cell" id="o_p2_m_6" rowspan="2">0.00</td>
</tr>
<tr>
<td class="time-cell">17:00</td>
<td><input id="p2m5117" inputmode="decimal" type="number"/></td>
<td><input id="p2m5217" inputmode="decimal" type="number"/></td>
<td><input id="p2m6117" inputmode="decimal" type="number"/></td>
<td><input id="p2m6217" inputmode="decimal" type="number"/></td>
</tr>
</tbody>
</table>
</div>
...
<!-- 二期助凝 -->
<div class="card">
<div class="card-header">二期 · 助凝剂</div>
<div class="card-body">
<div class="table-wrapper">
<table>
<thead>
...
<tr>
<td class="time-cell">8:00</td>
<td><input id="p2a518" inputmode="decimal" type="number"/></td>
<td><input id="p2a528" inputmode="decimal" type="number"/></td>
<td><input id="p2a618" inputmode="decimal" type="number"/></td>
<td><input id="p2a628" inputmode="decimal" type="number"/></td>
<td class="result-cell" id="o_p2_a_5" rowspan="2">0.00</td>
<td class="result-cell" id="o_p2_a_6" rowspan="2">0.00</td>
</tr>
<tr>
<td class="time-cell">17:00</td>
<td><input id="p2a5117" inputmode="decimal" type="number"/></td>
<td><input id="p2a5217" inputmode="decimal" type="number"/></td>
<td><input id="p2a6117" inputmode="decimal" type="number"/></td>
<td><input id="p2a6217" inputmode="decimal" type="number"/></td>
</tr>
</tbody>
</table>
</div>
...
<button class="btn-copy" onclick="copyReport()">📋 一键复制班报</button>
</div>
<div class="footer">
    药剂消耗核算系统 v2.0 | 数据自动保存
  </div>
</div>
<script>
// 获取输入值
...
`药剂消耗日报
一期混凝：一二系${p1m12.toFixed(2)} / 三四系${p1m34.toFixed(2)}（合计：${(p1m12+p1m34).toFixed(2)}）
一期助凝：一二系${p1a12.toFixed(2)} / 三四系${p1a34.toFixed(2)}（合计：${(p1a12+p1a34).toFixed(2)}）
二期混凝：五系${p2m5.toFixed(2)} / 六系${p2m6.toFixed(2)}（合计：${(p2m5+p2m6).toFixed(2)}）
二期助凝：五系${p2a5.toFixed(2)} / 六系${p2a6.toFixed(2)}（合计：${(p2a5+p2a6).toFixed(2)}）`;
